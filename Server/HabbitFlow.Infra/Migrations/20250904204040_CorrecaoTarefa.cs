    ...
    public partial class CorrecaoTarefa : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TBTAREFAS", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TBCOMPROMISSO_TBCATEGORIA_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "TBCATEGORIA",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TBSUBTAREFA", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TBSUBTAREFA_TBTAREFAS_TarefaId",
                        column: x => x.TarefaId,
                        principalTable: "TBTAREFAS",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TBCOMPROMISSO_CategoriaId",
                table: "TBCOMPROMISSO",
                column: "CategoriaId");
