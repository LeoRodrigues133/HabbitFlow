...
namespace HabbitFlow.Infra.orm.Migrations
{
    ...
    [Migration("20250914105913_ajusteCOmpromisso")]
    partial class ajusteCOmpromisso
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HabbitFlow.Dominio.ModuloAuth.Usuario", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HabbitFlow.Dominio.ModuloCompromisso.Compromisso", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HabbitFlow.Dominio.ModuloSubtarefa.SubTarefa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TBSUBTAREFA", (string)null);
                });
            ...
            modelBuilder.Entity("HabbitFlow.Dominio.ModuloTarefa.Tarefa", b =>
                {
                    ...
                    b.ToTable("TBTAREFAS", (string)null);
                });
            ...
            modelBuilder.Entity("HabbitFlow.Dominio.ModuloCompromisso.Compromisso", b =>
                {
                    ...
                    b.HasOne("HabbitFlow.Dominio.ModuloContato.Contato", "Contato")
                        .WithMany("Compromissos")
            ...
            modelBuilder.Entity("HabbitFlow.Dominio.ModuloSubtarefa.SubTarefa", b =>
                {
                    b.HasOne("HabbitFlow.Dominio.ModuloTarefa.Tarefa", "Tarefa")
                        .WithMany("Subtarefas")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("HabbitFlow.Dominio.ModuloAuth.Usuario", null)
                        .WithMany()
